#!/bin/bash
# Docker test script for Task 2.2: Auto-Start Recording When Commanded
# This script runs pytest tests inside the controller Docker container
# Run from repository root

set -e

echo "============================================="
echo "Testing Task 2.2: Auto-Start Recording When Commanded"
echo "============================================="
echo ""
...
echo "   Test file: /app/tests/unit/test_task_2_2_auto_start.py"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "============================================="
    echo "Task 2.2 tests passed! ✓"
    echo "============================================="
else
    echo "============================================="
    echo "Task 2.2 tests failed! ✗"
    echo "============================================="
fi
