#!/bin/bash
# Docker test script for Task 2.1: Recording Command Polling
...
echo "============================================="
echo "Testing Task 2.1: Recording Command Polling"
echo "============================================="
echo ""
...
echo "   Test file: /app/tests/unit/test_task_2_1_polling.py"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "============================================="
    echo "Task 2.1 tests passed! ✓"
    echo "============================================="
else
    echo "============================================="
    echo "Task 2.1 tests failed! ✗"
    echo "============================================="
fi
