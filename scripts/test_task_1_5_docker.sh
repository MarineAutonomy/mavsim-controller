#!/bin/bash
# Docker test script for Task 1.5: Statistics and Monitoring
# This script builds and runs the Docker container to test task 1.5

set -e

echo "============================================="
echo "Testing Task 1.5 in Docker Container"
echo "============================================="
echo ""
