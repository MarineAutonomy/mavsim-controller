#!/bin/bash
# Docker test script for Task 1.6: Main SensorBridge Class
# This script builds and runs the Docker container to test task 1.6

set -e

echo "=========================================="
echo "Testing Task 1.6 in Docker Container"
echo "=========================================="
echo ""
